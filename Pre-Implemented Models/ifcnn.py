...
Original file is located at
    https://colab.research.google.com/drive/1-vA5h70OwJHc0YxwzBIQoRwdM53quns9

# IFCNN fusion strategy to fuse multi-modelity input images
"""
...
import math
!nvidia-smi # used to manage and monitor GPU enabled nodes
...
#             %(epoch, counter, ssim_loss_mri, ssim_loss_pet, ssim_total, l2_total, loss_total))
    ...
    if(epoch == EPOCH -1):
      #Save a checkpoint
      torch.save(cnn.state_dict(), 'IFCNN_GLCM-I.pth')
...
import numpy as np
img1=imread("c01_2.gif")
img2=imread("c01_1.gif")
...
matplotlib.image.imsave('IFCNN_01.gif', ffused)